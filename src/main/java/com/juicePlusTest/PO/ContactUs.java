...
public class ContactUs extends DriverMain {
	...
	//private final WebElement content = driver.findElement(By.xpath("/html/body/div[2]/div[6]/div/div[2]/div/div[1]/div/div/h6"));
	
	private final WebElement successMsg = driver.findElement(By.xpath("//*[@class='confirmation']/strong"));
